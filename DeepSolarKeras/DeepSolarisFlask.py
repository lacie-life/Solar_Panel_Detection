...
model.load_weights('/home/jun/Github/Solar_Panel_Detection/DeepSolarKeras/static/vgg16_3t_wmp_wr_aachen__06_0.89.hdf5')
graph = tf.compat.v1.get_default_graph()
country = "Germany"
# wms = WebMapService('https://www.wms.nrw.de/geobasis/wms_nw_dop', version='1.1.1')  # Germany
wms = WebMapService('https://ows.terrestris.de/osm/service', version='1.1.1')
